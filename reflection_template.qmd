...
# Lab 5 
# Revised formattin for clearer code
get_fit_now_member |> 
  left_join(get_fit_now_check_in, by = join_by(id == membership_id)) |> 
  left_join(interview, by = join_by(person_id)) |> 
  mutate(check_in_date = ymd(check_in_date)) |> 
...
Comments were provided on each stating what i revised and why I revised it to meet the portfolio expectations.
